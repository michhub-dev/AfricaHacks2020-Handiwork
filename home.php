            ...
            <div class="input-group space20">
              ...
              <div class="input-group-append move-icon-up">
                <button name="search" type="submit" class="search_button">
                    <img src="../Downloads/gigtodo-153nulled/codecanyon-23855397-gigtodo-freelance-marketplace-script/GigToDoScript%20V1.5.3/gigtodo/images/srch2.png" class="srch2">
                </button>
              </div>
            </div>
          </form>
