      ...
      <div class="card-body p-0">
        ...
        <div class="row pl-3 pr-3 pb-2 pt-2 mt-4">
          <div class="col-md-4 text-center border-box">
            <?php
              ...
              ?>
              <img width="" src="../Downloads/gigtodo-153nulled/codecanyon-23855397-gigtodo-freelance-marketplace-script/GigToDoScript%20V1.5.3/gigtodo/images/comp/completed.png" alt="completed">
          ...
          <div class="col-md-4 text-center border-box">
            ...
            <img width="" src="../Downloads/gigtodo-153nulled/codecanyon-23855397-gigtodo-freelance-marketplace-script/GigToDoScript%20V1.5.3/gigtodo/images/comp/box.png" alt="box">
          ...
          <div class="col-md-4 text-center border-box">
            ...
            <img width="" src="../Downloads/gigtodo-153nulled/codecanyon-23855397-gigtodo-freelance-marketplace-script/GigToDoScript%20V1.5.3/gigtodo/images/comp/cancellation.png" alt="cancellation">
        ...
        <div class="row pl-3 pr-3 pb-2 pt-2">
          <div class="col-md-3 text-center border-box">
            ...
            ?>
            <img width="" src="../Downloads/gigtodo-153nulled/codecanyon-23855397-gigtodo-freelance-marketplace-script/GigToDoScript%20V1.5.3/gigtodo/images/comp/debt.png" alt="debt">
          ...
          <div class="col-md-3 text-center border-box">
            <?php $count_orders = $db->count("orders",array("buyer_id" => $login_seller_id, "order_active" => 'yes')); ?>
              <img width="" src="../Downloads/gigtodo-153nulled/codecanyon-23855397-gigtodo-freelance-marketplace-script/GigToDoScript%20V1.5.3/gigtodo/images/comp/shopping-bags.png" alt="shopping-bags">
            <h5 class="text-muted pt-2"> <?= $lang["dashboard"]['open_purchases']; ?></h5>
            <h3 class="text-success"><?= $count_orders; ?> </h3>
          </div>
          <div class="col-md-3 text-center border-box">
            <img width="" src="../Downloads/gigtodo-153nulled/codecanyon-23855397-gigtodo-freelance-marketplace-script/GigToDoScript%20V1.5.3/gigtodo/images/comp/accounting.png" alt="accounting">
            <h5 class="text-muted pt-2"> <?= $lang["dashboard"]['balance']; ?></h5>
            <h3 class="text-success"><?= showPrice($current_balance); ?></h3>
          </div>
          <div class="col-md-3 text-center border-box">
            <img width="" src="../Downloads/gigtodo-153nulled/codecanyon-23855397-gigtodo-freelance-marketplace-script/GigToDoScript%20V1.5.3/gigtodo/images/comp/financial.png" alt="financial">
